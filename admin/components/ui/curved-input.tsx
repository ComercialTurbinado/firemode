...
const SHADOWS = {
  none: null,
  sm: [5, 12, 0.3] as const,
  md: [10, 24, 0.4] as const,
  lg: [16, 40, 0.52] as const,
};
...
export default function CurvedInput({
  ...
  const handleSelect = (e: React.SyntheticEvent<HTMLInputElement>) => {
    ...
    setCaretIndex(t.selectionStart ?? t.value.length);
  };

  const handleSubmit = (e?: FormEvent | PointerEvent | KeyboardEvent) => {
